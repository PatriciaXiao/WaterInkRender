...
# feature map = model the features
class FeatureMap:
...
# conspicuity map = how obvious are the features
...
# create saliency map
# steps: 1. pyramid; 2. feature; 3. conspicuity; 4. saliency
class SaliencyMap:
	def __init__(self, src):
	...
	# calculate the final result of saliency map
